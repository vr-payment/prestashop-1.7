...
class VRPaymentBasemodule
{
    ...
    const CK_CHECKOUT_TYPE = 'VRP_CHECKOUT_TYPE';
    ...
    public function checkRequirements(VRPayment $module)
    {
        try {
    ...
    private function installControllers(VRPayment $module)
    {
     ...
     * @return string
     */
    public static function handleSaveCheckoutTypeSettings(VRPayment $module)
    {
        $output = "";
    ...
    public static function getCheckoutTypeForm(VRPayment $module)
    {
        return array(
            'legend' => array(
     ...
     * @return mixed[]
     */
    public static function getCheckoutTypeConfigValues(VRPayment $module)
    {
        $values = array();
        if (! $module->getContext()->shop->isFeatureActive() || $module->getContext()->shop->getContext() == Shop::CONTEXT_SHOP) {
