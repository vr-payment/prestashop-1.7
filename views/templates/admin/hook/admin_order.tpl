...
{if (isset($showAuthorizedActions) && $showAuthorizedActions)}
	<div style="display:none;" class="hidden-print">
		<a class="btn btn-default vrpayment-management-btn"  id="vrpayment_void">
			<i class="icon-remove"></i>
			{l s='Void' mod='vrpayment'}
		</a>
		<a class="btn btn-default vrpayment-management-btn"  id="vrpayment_completion">
			<i class="icon-check"></i>
			{l s='Completion' mod='vrpayment'}
		</a>	
	</div>
	
	{addJsDefL name=vrpayment_void_title}{l s='Are you sure?' mod='vrpayment' js=1}{/addJsDefL}
	{addJsDefL name=vrpayment_void_btn_confirm_txt}{l s='Void Order'  mod='vrpayment' js=1}{/addJsDefL}
	{addJsDefL name=vrpayment_void_btn_deny_txt}{l s='No' mod='vrpayment' js=1}{/addJsDefL}
	...
	{addJsDefL name=vrpayment_completion_title}{l s='Are you sure?' mod='vrpayment' js=1}{/addJsDefL}
	{addJsDefL name=vrpayment_completion_btn_confirm_txt}{l s='Complete Order'  mod='vrpayment' js=1}{/addJsDefL}
	{addJsDefL name=vrpayment_completion_btn_deny_txt}{l s='No' mod='vrpayment' js=1}{/addJsDefL}
...
{addJsDefL name=vrpayment_msg_general_error}{l s='The server experienced an unexpected error, please try again.'  mod='vrpayment' js=1}{/addJsDefL}
{addJsDefL name=vrpayment_msg_general_title_succes}{l s='Success'  mod='vrpayment' js=1}{/addJsDefL}
{addJsDefL name=vrpayment_msg_general_title_error}{l s='Error'  mod='vrpayment' js=1}{/addJsDefL}
{addJsDefL name=vrpayment_btn_info_confirm_txt}{l s='OK'  mod='vrpayment' js=1}{/addJsDefL}
