...
<tr>
	...
	<td class="actions">
		<div class="btn-group-action">
			<div class="btn-group">
				<a class=" btn btn-default" href={$link->getAdminLink('AdminVRPaymentMethodSettings')|escape:'html'}&method_id={$method.id|escape:'html':'UTF-8'} title="{l s='Configure' mod='vrpayment'}"><i class="icon-wrench"></i> {l s='Configure' mod='vrpayment'}</a>
			</div>
		</div>
	</td>
</tr>
